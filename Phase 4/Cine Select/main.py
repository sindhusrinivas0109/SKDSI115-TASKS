...
def about():
    suggestions = get_suggestions()
    return render_template('about.html', suggestions=suggestions)

@app.route("/contact")
def contact():
    suggestions = get_suggestions()
    return render_template('contact.html', suggestions=suggestions)
...
@app.route("/shift_signup")
def shift_signup():
    suggestions = get_suggestions()
    return render_template('signup.html', suggestions=suggestions)


@app.route("/shift_login")
def shift_login():
    suggestions = get_suggestions()
    return render_template('login.html', suggestions=suggestions)
